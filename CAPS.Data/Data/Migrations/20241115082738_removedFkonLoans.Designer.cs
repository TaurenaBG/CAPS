...
namespace CAPS.Data.Data.Migrations
{
    ...
    [Migration("20241115082738_removedFkonLoans")]
    partial class removedFkonLoans
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CAPS.DataModels.Loan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CAPS.DataModels.PawnShop", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CAPS.DataModels.Loan", b =>
                {
                    ...
                    b.HasOne("CAPS.DataModels.PawnShop", null)
                        .WithMany("Loans")
            ...
            modelBuilder.Entity("CAPS.DataModels.Payment", b =>
                {
                    ...
                    b.HasOne("CAPS.DataModels.Loan", "Loan")
                        .WithMany("Payments")
                        .HasForeignKey("LoanId");

                    b.HasOne("CAPS.DataModels.PawnItem", "PawnItem")
                        .WithMany("Payments")
                        .HasForeignKey("PawnItemId");

                    b.Navigation("AppUser");

                    b.Navigation("Loan");

                    b.Navigation("PawnItem");
                });
